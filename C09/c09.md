...
• A shell script called libft_creator.sh will compile the source files appropriately
...
• It should compile the .c files with cc and with -Wall -Wextra -Werror flags in
that order.
