...
• Create a ft_boolean.h file. It will compile and run the following main appropriately:
...
• The structure will be defined in the ft_stock_str.h file that we will provide, like
this:
...
• The returned array should be allocated in memory and its last element’s str set to
